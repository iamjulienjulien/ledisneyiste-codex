...
import {
    PixieSwitch,
    type PixieSwitchColor,
    type PixieSwitchEffect,
    type PixieSwitchMotion,
    type PixieSwitchSize,
    type PixieSwitchVariant,
} from "@/components/ui/PixieSwitch";
import { PixieSwitchAsyncDemo } from "./PixieSwitchAsyncDemo";
import { PixieSwitchPlayground } from "./PixieSwitchPlayground";
...
export function PixieSwitchDossier() {
    return (
        <AtelierFicheAccessoire
            id="pixie-switch"
            labelledBy="pixie-switch-title"
            nom="PixieSwitch"
    ...
    />
                ...
                <section aria-labelledby="switch-states-title">
                    ...
                    <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                        <Stage>
                            <PixieSwitch aria-label="Préférence inactive" />
                ...
                <section aria-labelledby="switch-async-title">
                    ...
                    <div className="mt-8 grid gap-5 lg:grid-cols-2">
                        <Stage>
                            <PixieSwitchAsyncDemo />
                        </Stage>
                        <CodeExample>{`<PixieSwitch
