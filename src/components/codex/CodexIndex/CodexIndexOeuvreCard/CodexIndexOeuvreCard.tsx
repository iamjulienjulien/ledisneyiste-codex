...
export function CodexIndexOeuvreCard({
    oeuvre,
    fiche,
    identite,
    recompenses,
}: CodexIndexOeuvreCardProps) {
    return (
        <PixieCard
            asChild
            variant="accent"
                ...
                <div className="flex items-start justify-between gap-5">
                    <div className="min-w-0">
                        ...
                        <CodexCommonIdentite
                            ...
                            presence="card"
                            className="mt-5"
                            titleClassName="transition-colors group-hover:text-famille-oeuvres group-focus-visible:text-famille-oeuvres"
                        />
                    </div>
                            ...
                            >
                                {recompenses.map((recompense) => (
                                    ...
                                    >
                                        ...
                                        <span
                                            className={styles.recompenseLabel}
                                        >
